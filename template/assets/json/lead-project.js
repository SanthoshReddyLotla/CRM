    ...
    if($('#lead-project').length > 0) {
		...
		"columns": [
			{ "render": function ( data, type, row ){
				return '<a href="leads-details.php">'+row['lead']+'</a>';
			}},
			{ "render": function ( data, type, row ){
				return '<div class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-rounded border"><img class="w-auto h-auto" src="'+row['lead_img']+'" alt="User Image"></a><div class="ms-2"><h6 class="fs-14 fw-medium mb-0"><a href="company-details.php" class="d-flex flex-column">'+row['lead_name']+'</a></h6></div></div>';
			}},
			{ "data": "phone" },
			{ "render": function ( data, type, row ){
